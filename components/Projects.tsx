          ...
          {projects.map((project, index) => (
            <Reveal as="li" key={project.id} delay={Math.min(index * 0.07, 0.35)}>
              <button
                ...
                className="group relative block h-full w-full overflow-hidden border border-white/[0.08] text-left transition-colors duration-500 hover:border-gold/40"
              >
                <div className="relative aspect-4/3">
                  <Image
                    ...
                    className="object-cover brightness-[0.88] saturate-[0.8] transition-all duration-[900ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-[1.06] group-hover:brightness-100 group-hover:saturate-100"
                  />
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-4 p-6 sm:p-7">
                  <div className="min-w-0">
                    ...
                    <h3 className="display mt-2.5 text-2xl text-white sm:text-[1.75rem]">
                      {project.title}
                    </h3>
                  </div>
                  <span
                    className="flex size-11 shrink-0 items-center justify-center border border-white/20 text-white transition-all duration-500 group-hover:border-gold group-hover:bg-gold group-hover:text-black"
                    aria-hidden="true"
                  >
